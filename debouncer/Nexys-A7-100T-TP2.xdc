...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { fled[0] }]; #IO_L16N_T2_A15_D31_14 Sch=led[8]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { fled[1] }]; #IO_L14N_T2_SRCC_14 Sch=led[9]
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { fled[2] }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { fled[3] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { fled[4] }]; #IO_L16P_T2_CSI_B_14 Sch=led[12]
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { fled[5] }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { fled[6] }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { fled[7] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
# set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports {  }];     #IO_L9P_T1_DQS_14 Sch=btnc         #MIDDLE
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { rst }];    #IO_L4N_T0_D05_14 Sch=btnu       #TOP
# set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports {  }];     #IO_L12P_T1_MRCC_14 Sch=btnl       #LEFT
# set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports {  }];     #IO_L10N_T1_D15_14 Sch=btnr        #RIGHT
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { b_in }];     #IO_L9N_T1_DQS_D13_14 Sch=btnd   #BOTTOM
